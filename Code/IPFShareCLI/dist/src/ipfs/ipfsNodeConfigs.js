...
export function newNodeConfig(type = 'go', options = { apiPort: 5002, gateawayPort: 8090, swarmPort: 4002 }) {
    if (type === 'go') {
        return newGoConfig(options);
    }
    return newJsConfig(options);
}
//# sourceMappingURL=ipfsNodeConfigs.js.map